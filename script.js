const options = {
	...
	lecturerDescriptors: ['wore a hat even though it was 28 degrees', 'lost their mind when someone took an audible screenshot', 'came in full fancy dress', 'reminds me of a puppy', 'I think might have been in Backstreet Boyz', "apparently is a camel because we didn't have a single loo break", "serenaded us with late 90's pop", 'I think only owns a single black hoody', 'sang us hold music whilst their computer took 17 minutes to install react', "couldn't quite compare to Alex", "made a regex they described as 'flawless'. Spoiler alert: it wasn't flawless", "showed us the 'ultimate programmer move' - copying and pasting"],
	...
	pairPartners: ['was a rubber duck', 'was Hal from 2001: A Space Odyssey and kept trying to push me out of the airlock', 'only spoke in binary', 'was a reflection of myself in the mirror', 'said they’d never met a coding genius like me', 'was on a road trip the entire time', 'was having broadband issues and had to communicate in semaphore', 'spent two hours stuck in vim', 'lost control of their motion-activated standing desk', 'was just. so. intimidatingly. cool', "kept quoting passages from Tia's blog", 'got their cat to type out all their code', 'was Ben', "said we should code in Java instead because it's basically the same"],
