const options = {
	kataHourActivities: ['converted my birth date into an array of Roman numerals and back', 'calculated the sum of all Prime Numbers under 3', 'busily ignored the katas and chatted to my tutor about stained glass windows', 'stared at a blank vscode window whilst drinking my coffee', 'had to map an array without using map or arrays', 'had to make a FizzBuzz which outputted Fizz whenever it was a multiple of 3 and outputted Buzz on the heat death of the universe', 'had to make a FizzBuzz using only regular expressions', 'had to figure out how to exit vim'],
